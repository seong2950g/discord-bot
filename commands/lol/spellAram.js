...
module.exports = {
	data: new SlashCommandBuilder()
		.setName('칼바람스펠')
		.setDescription('칼바람 추천 스펠 정보를 제공합니다.')
    ...
    async execute(interaction) {
        ...
        const { championInfo, spellList } = await this.getSpellAram(engChampionName);
        ...
        .setURL(`https://www.op.gg/modes/aram/${engChampionName}/build?region=${info.region}&tier=${info.tier}&patch=${info.patch}`)
        .setColor("#00b0f4")
    ...
    async getSpellAram(engChampionName) {
